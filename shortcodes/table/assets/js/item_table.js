        ...
        spanProcess: function(parent_wrap){
            ...
            $.each(extract_data.text().split('#'), function(key, value){
                if(value){
                    ...
                    if(attr_value <= 0){
                        alert(Ig_Translate.table.table3);
                        error = 1;
                    }
            ...
            var max_col = table.find('tr.ig-row-of-delete').find('td').length;
            ...
            switch (type) {
                    case 'column':
                        ...
                        if($("#table_content tr").last().find('td').length == 1){
                            alert(Ig_Translate.table.table1);
                            return true;
                        }
                    ...
                    case 'row':
                        ...
                        if($("#table_content tr").length == 3){
                            alert(Ig_Translate.table.table2);
                            return true;
                        }
