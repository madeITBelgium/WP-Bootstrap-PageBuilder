...
if ( ! class_exists( 'IG_Init_Admin_Menu' ) ) :
...
class IG_Init_Admin_Menu {
	 ...
	 *     array(
	 *         'page_title' => 'IG Sample - All Items',
	 *         'menu_title' => 'IG Sample',
	 *         'capability' => 'edit_posts',
	 *         'menu_slug'  => 'ig-sample-all-items',
	 *         'function'   => 'ig_sample_all_items',
	 *         'children'   => array(
	 *             array(
	 *                 'page_title' => 'IG Sample - All Items',
	 ...
	 *             ),
	 *             array(
	 *                 'page_title' => 'IG Sample - Add New Item',
	 *                 'menu_title' => 'Add New',
	 *                 'capability' => 'edit_posts',
	 *                 'menu_slug'  => 'ig-sample-add-new',
	 *                 'function'   => 'ig_sample_add_new'
	 *             )
	 *         )
	 *     )
	 * );
	...
	public static function admin_menu() {
		...
		self::$add = apply_filters( 'ig_register_admin_menu', self::$add );
