...
class IG_Pb_Addon {
	...
	/**
	 * Get custom enqueued assets for IG modal
	 *
	 * @return type
	 */
	...
	/**
	 * Add custom assets for IG modal
	 *
	 * @param array $assets
	 */
	...
	public function __construct() {
		add_filter( 'ig_pb_provider', array( &$this, 'get_provider_data' ) );
		add_filter( 'ig_register_assets', array( &$this, 'register_assets_register' ) );
		add_filter( 'ig_pb_assets_enqueue_admin', array( &$this, 'enqueue_assets_admin' ) );
		add_filter( 'ig_pb_assets_enqueue_modal', array( &$this, 'enqueue_assets_modal' ) );
		add_filter( 'ig_pb_assets_enqueue_frontend', array( &$this, 'enqueue_assets_frontend' ) );
	}
	...
	/**
	 * Register custom assets for IG modal
	 *
	 * @param array $assets
	 *
	 * @return array
		...
		switch ( $action ) {
			...
			case 'core_required':
				...
				<div class="<?php echo esc_attr( $type ); ?>">
					<p>
						<?php _e( "You can not activate this IG PageBuilder's provider:", IGPBL ); ?> <br>
	...
	/**
	 * Check compatibility of this addon & IG core
	 *
	 * @param string $core_required
